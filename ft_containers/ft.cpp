...
int main()
{
	...
	for (int i(0); i < 1e6; ++i)
		m.insert(ft::make_pair(i, std::string()));
	...
	std::cout << "\033[0;32m"
			  << "// find(5)"
			  << "\033[0m" << std::endl;
	ft::map<int, std::string>::iterator it5 = m.find(5);
	std::cout << "it5->first = " << it5->first << std::endl;
	std::cout << "it5->second = " << it5->second << std::endl;
	std::cout << "\033[0;32m"
			  << "// find(50)"
			  << "\033[0m" << std::endl;
	ft::map<int, std::string>::iterator it50 = m.find(50);
	...
	std::cout << "\033[0;32m"
			  << "// lower_bound(10)"
			  << "\033[0m" << std::endl;
	ft::map<int, std::string>::iterator it_lower = m.lower_bound(10);
	...
	std::cout << "\033[0;32m"
			  << "// upper_bound(10)"
			  << "\033[0m" << std::endl;
	ft::map<int, std::string>::iterator it_upper = m.upper_bound(10);
